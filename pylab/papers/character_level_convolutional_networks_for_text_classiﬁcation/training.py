...
from pylab.papers.character_level_convolutional_networks_for_text_classiﬁcation.config import config
from pylab.papers.character_level_convolutional_networks_for_text_classiﬁcation.char_cnn import CharConvNet
from pylab.papers.character_level_convolutional_networks_for_text_classiﬁcation.data_utils import DataUtils

if __name__ == '__main__':
    # 加载数据集
    train_data = DataUtils(data_source=config.train_data_source,
                           alphabet=config.alphabet,
                           input_size=config.input_size,
                           batch_size=config.batch_size,
                           num_of_classes=config.num_of_classes)
    train_data.load_data()
    dev_data = DataUtils(data_source=config.dev_data_source,
                         alphabet=config.alphabet,
                         input_size=config.input_size,
                         batch_size=config.batch_size,
                         num_of_classes=config.num_of_classes)
